"""
In case you just want to extract the protein embeddings before input to the UCE pretrained model:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", type=str, default="./", help="Working folder where all files will be saved.")
    ...
    if not anndata_files:
        ...
        for anndata_file in anndata_files:
            ...
            output_subdir = os.path.join(save_root_dir, dataset_name)
